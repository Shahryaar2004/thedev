    ...
    <>
      ...
      <div className="w-full flex">
        <p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          The following projects were built using the MERN stack (MongoDB, Express.js, React.js, Node.js) and other modern technologies. Each project demonstrates my ability to design and develop full-stack web applications with real-world functionality. From creating responsive front-ends to implementing robust back-end features, these projects showcase my hands-on experience in solving practical problems. Brief descriptions are provided along with links to code repositories and live demos, reflecting my journey of continuous learning and growth as a MERN developer.
        </p>
      </div>
